class CallLogsController < ApplicationController
  ...
  private
    ...
    def call_log_params
      params.require(:call_log).permit(:entered_by, :date, :starttime, :endtime, :int, :math, :worksheet, :stoodle, :image_share, :textbook, :page, :chaptitle, :notes, :skill, :startknow, :endknow)
    end
end
