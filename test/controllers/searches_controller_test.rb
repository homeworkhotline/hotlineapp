...
class SearchesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create search" do
    assert_difference('Search.count') do
      post searches_url, params: { search: { model: @search.model, search: @search.search, select: @search.select } }
    end
  ...
  test "should update search" do
    patch search_url(@search), params: { search: { model: @search.model, search: @search.search, select: @search.select } }
